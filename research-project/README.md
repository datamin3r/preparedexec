...
[code](./research-project/data/README.md#code-area) - Code required to execute the application   

[data](./research-project/data/README.md#data-area) - Data required to execute the application 
