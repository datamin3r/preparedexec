...
This script reads the executive analysts sequenced results JSON file
and create a new JSON file which has all the answers for a given executive for 
on a specific conference call.
...
# set the filename to select the executive answers from 
fname = "transcript_may31_seq_resultDiageo-Europe-Russia-and-Turkey-Call-with-the-Pres_09_16.json"
#"transcript_may31_seq_resulttranscripts_may31_TAP_Q2_16.json"
...
text = ''
# Set the executive's name to select their answers from the call transcript 
