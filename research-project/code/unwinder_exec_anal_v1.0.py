...
This script reads a Q&A JSON transcript file produced by 
the Scrapy script (made aavailable in an authors previous work
in April 2017) and outputs a trasformed JSON file
which splits executive and analyst questions and answers
and provides a utterance sequence number
...
# change to load a chosen transcript JSON file 
fname = "transcripts_may31_Pernod_Q4_14.json"
